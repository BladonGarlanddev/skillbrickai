...
\restrict m7L6NozQeGnSv4Hbe9UXqsQj7YrymJ5EgYUhgOva2FVqE5haIgbpRI84TbN8xJ3
...
--
-- Name: BadgeType; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: PostCategory; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public."PostCategory" AS ENUM (
    'GENERAL',
    'HELP',
    'IDEAS',
    'SHOW_AND_TELL'
...
--
-- Name: SkillRequestStatus; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public."SkillRequestStatus" AS ENUM (
    'OPEN',
    'FULFILLED'
);
...
--
-- Name: TokenTransactionType; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public."TokenTransactionType" AS ENUM (
    'ACCOUNT_CREATED',
    'SKILL_POSTED',
    'SKILL_INSTALLED',
    'ADMIN_GRANT'
...
--
-- Name: UpvoteTarget; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public."UpvoteTarget" AS ENUM (
    'SKILL',
    'POST',
    'REPLY',
    'SHOWCASE'
...
--
-- Name: CollectionSkill; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."CollectionSkill" (
...
--
-- Name: ShowcaseSkill; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."ShowcaseSkill" (
...
--
-- Name: SkillRequest; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."SkillRequest" (
    id text NOT NULL,
    title text NOT NULL,
    description text NOT NULL,
    "authorId" text NOT NULL,
    status public."SkillRequestStatus" DEFAULT 'OPEN'::public."SkillRequestStatus" NOT NULL,
    "createdAt" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);


--
-- Name: SkillRequestReply; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."SkillRequestReply" (
    id text NOT NULL,
...
--
-- Name: SkillTag; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: SkillTestedOn; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."SkillTestedOn" (
    "skillId" text NOT NULL,
    model text NOT NULL
);
...
--
-- Name: TokenTransaction; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public."Upvote" (
    id text NOT NULL,
    "userId" text NOT NULL,
    "targetType" public."UpvoteTarget" NOT NULL,
...
--
-- Data for Name: CollectionSkill; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: ImprovementSuggestion; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: ShowcaseSkill; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: SkillRequest; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: SkillRequestReply; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: SkillTag; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: SkillTestedOn; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: TokenTransaction; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: Upvote; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Name: CollectionSkill CollectionSkill_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."CollectionSkill"
    ADD CONSTRAINT "CollectionSkill_pkey" PRIMARY KEY ("collectionId", "skillId");
...
--
-- Name: ShowcaseSkill ShowcaseSkill_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ShowcaseSkill"
    ADD CONSTRAINT "ShowcaseSkill_pkey" PRIMARY KEY ("showcaseId", "skillId");
...
--
-- Name: SkillRequestReply SkillRequestReply_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."SkillRequestReply"
    ADD CONSTRAINT "SkillRequestReply_pkey" PRIMARY KEY (id);


--
-- Name: SkillRequest SkillRequest_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."SkillRequest"
    ADD CONSTRAINT "SkillRequest_pkey" PRIMARY KEY (id);


--
-- Name: SkillTag SkillTag_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."SkillTag"
    ADD CONSTRAINT "SkillTag_pkey" PRIMARY KEY ("skillId", tag);


--
-- Name: SkillTestedOn SkillTestedOn_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."SkillTestedOn"
    ADD CONSTRAINT "SkillTestedOn_pkey" PRIMARY KEY ("skillId", model);
...
--
-- Name: TokenTransaction TokenTransaction_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."TokenTransaction"
    ADD CONSTRAINT "TokenTransaction_pkey" PRIMARY KEY (id);
...
--
-- Name: Badge_userId_type_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "Badge_userId_type_key" ON public."Badge" USING btree ("userId", type);


--
-- Name: Upvote_userId_targetType_targetId_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "Upvote_userId_targetType_targetId_key" ON public."Upvote" USING btree ("userId", "targetType", "targetId");
...
--
-- Name: Badge Badge_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: CollectionSkill CollectionSkill_collectionId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."CollectionSkill"
    ADD CONSTRAINT "CollectionSkill_collectionId_fkey" FOREIGN KEY ("collectionId") REFERENCES public."Collection"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: CollectionSkill CollectionSkill_skillId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."CollectionSkill"
    ADD CONSTRAINT "CollectionSkill_skillId_fkey" FOREIGN KEY ("skillId") REFERENCES public."Skill"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: Collection Collection_authorId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."Collection"
    ADD CONSTRAINT "Collection_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: ImprovementSuggestion ImprovementSuggestion_authorId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ImprovementSuggestion"
    ADD CONSTRAINT "ImprovementSuggestion_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: ImprovementSuggestion ImprovementSuggestion_skillId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ImprovementSuggestion"
    ADD CONSTRAINT "ImprovementSuggestion_skillId_fkey" FOREIGN KEY ("skillId") REFERENCES public."Skill"(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
--
-- Name: Post Post_parentId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."Post"
    ADD CONSTRAINT "Post_parentId_fkey" FOREIGN KEY ("parentId") REFERENCES public."Post"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: ShowcaseSkill ShowcaseSkill_showcaseId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ShowcaseSkill"
    ADD CONSTRAINT "ShowcaseSkill_showcaseId_fkey" FOREIGN KEY ("showcaseId") REFERENCES public."Showcase"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: ShowcaseSkill ShowcaseSkill_skillId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ShowcaseSkill"
    ADD CONSTRAINT "ShowcaseSkill_skillId_fkey" FOREIGN KEY ("skillId") REFERENCES public."Skill"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: Showcase Showcase_authorId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."Showcase"
    ADD CONSTRAINT "Showcase_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: SkillRequestReply SkillRequestReply_requestId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."SkillRequestReply"
    ADD CONSTRAINT "SkillRequestReply_requestId_fkey" FOREIGN KEY ("requestId") REFERENCES public."SkillRequest"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: SkillRequest SkillRequest_authorId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."SkillRequest"
    ADD CONSTRAINT "SkillRequest_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: SkillTag SkillTag_skillId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."SkillTag"
    ADD CONSTRAINT "SkillTag_skillId_fkey" FOREIGN KEY ("skillId") REFERENCES public."Skill"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: SkillTestedOn SkillTestedOn_skillId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."SkillTestedOn"
    ADD CONSTRAINT "SkillTestedOn_skillId_fkey" FOREIGN KEY ("skillId") REFERENCES public."Skill"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: Skill Skill_authorId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."Skill"
    ADD CONSTRAINT "Skill_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: TokenTransaction TokenTransaction_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."TokenTransaction"
    ADD CONSTRAINT "TokenTransaction_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: Upvote Upvote_targetId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."Upvote"
    ADD CONSTRAINT "Upvote_targetId_fkey" FOREIGN KEY ("targetId") REFERENCES public."Skill"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: Upvote Upvote_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."Upvote"
    ADD CONSTRAINT "Upvote_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
\unrestrict m7L6NozQeGnSv4Hbe9UXqsQj7YrymJ5EgYUhgOva2FVqE5haIgbpRI84TbN8xJ3
